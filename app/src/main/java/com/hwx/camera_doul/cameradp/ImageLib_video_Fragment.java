...
/**
 */
public class ImageLib_video_Fragment extends BaseFragment {
    ...
    private void initAdapter() {
        adapter = new QuickAdapter(initData(Environment.DIRECTORY_MOVIES));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                adapter.setNewData(initData(Environment.DIRECTORY_MOVIES));
